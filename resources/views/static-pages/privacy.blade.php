...
<head>
    ...
    <title>سياسة الخصوصية - إنجب</title>
    <meta name="description" content="سياسة الخصوصية لموقع إنجب - تعرف على كيفية حماية معلوماتك الشخصية وخصوصيتك">
    <meta name="keywords" content="سياسة الخصوصية, إنجب, حماية البيانات, الخصوصية, معلومات شخصية">
...
<body class="bg-gray-50">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div>
                        ...
                        <div class="space-y-2">
                            <p class="text-gray-300"><i class="fas fa-envelope mr-2"></i> privacy@engeb.com</p>
    ...
    <script>
        // تحميل محتوى سياسة الخصوصية من API
