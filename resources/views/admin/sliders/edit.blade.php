                            ...
                            <div class="col-md-8">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('badge') is-invalid @enderror" 
                                                   id="badge" name="badge" value="{{ old('badge', $slider->badge) }}" 
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="url" class="form-control @error('background_image') is-invalid @enderror" 
                                           id="background_image" name="background_image" value="{{ old('background_image', $slider->background_image) }}" 
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('gradient_color') is-invalid @enderror" 
                                        ...
                                        <option value="from-green-600 to-emerald-600" {{ old('gradient_color', $slider->gradient_color) == 'from-green-600 to-emerald-600' ? 'selected' : '' }}>أخضر</option>
                                        <option value="from-blue-500 to-cyan-500" {{ old('gradient_color', $slider->gradient_color) == 'from-blue-500 to-cyan-500' ? 'selected' : '' }}>أزرق</option>
                                        <option value="from-red-500 to-rose-500" {{ old('gradient_color', $slider->gradient_color) == 'from-red-500 to-rose-500' ? 'selected' : '' }}>أحمر</option>
                                        <option value="from-purple-500 to-pink-500" {{ old('gradient_color', $slider->gradient_color) == 'from-purple-500 to-pink-500' ? 'selected' : '' }}>بنفسجي</option>
                                        <option value="from-orange-500 to-yellow-500" {{ old('gradient_color', $slider->gradient_color) == 'from-orange-500 to-yellow-500' ? 'selected' : '' }}>برتقالي</option>
                                    </select>
