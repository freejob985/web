            ...
            <div class="card shadow-sm">
                <div class="card-header bg-warning text-dark">
                    <h3 class="card-title mb-0">
                        <i class="fas fa-edit me-2"></i>تعديل القسم: {{ $category->name_ar }}
                    </h3>
                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control @error('description_ar') is-invalid @enderror" 
                                              ...
                                              placeholder="أدخل وصف القسم بالعربية">{{ old('description_ar', $category->description_ar) }}</textarea>
                                        ...
                                        <div class="mb-3">
                                            <div class="d-flex align-items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <small class="text-muted">اختر صورة جديدة لاستبدالها</small>
                                                </div>
                                            </div>
                                        </div>
                                    @endif
