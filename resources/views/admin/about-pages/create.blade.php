            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="mb-0">
                        ...
                        إضافة محتوى جديد لصفحة "من نحن"
                    </h3>
                    <p class="text-muted mb-0">أضف محتوى جديد لأحد أقسام صفحة "من نحن"</p>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="content" id="content" class="form-control @error('content') is-invalid @enderror" 
                                              rows="8" placeholder="اكتب محتوى القسم هنا...">{{ old('content') }}</textarea>
                                    @error('content')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    @enderror
                                    <div class="mt-2">
                                        <img id="imagePreview" src="" alt="معاينة الصورة" class="img-fluid rounded" style="display: none; max-height: 200px;">
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="meta_keywords" id="meta_keywords" class="form-control @error('meta_keywords') is-invalid @enderror" 
                                                   value="{{ old('meta_keywords') }}" placeholder="كلمة1, كلمة2, كلمة3">
                                            @error('meta_keywords')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
...
// Auto-fill section based on URL parameter
