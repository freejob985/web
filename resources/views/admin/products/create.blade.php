        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input class="form-control @error('name') is-invalid @enderror" type="text" name="name" required value="{{ old('name') }}" placeholder="أدخل اسم المنتج" />
                    @error('name')
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        <input class="form-control @error('sku') is-invalid @enderror" type="text" name="sku" id="sku" required value="{{ old('sku') }}" placeholder="كود المنتج" />
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input class="form-control @error('barcode') is-invalid @enderror" type="text" name="barcode" value="{{ old('barcode') }}" placeholder="الباركود (اختياري)" />
                    @error('barcode')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-12 mb-3">
                    ...
                    <textarea id="description" name="description" class="form-control" rows="4" placeholder="وصف المنتج">{{ old('description') }}</textarea>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input class="form-control @error('price') is-invalid @enderror" type="number" step="0.001" name="price" required value="{{ old('price') }}" placeholder="0.000" />
                    @error('price')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-4 mb-3">
                    ...
                    <input class="form-control @error('original_price') is-invalid @enderror" type="number" step="0.001" name="original_price" value="{{ old('original_price') }}" placeholder="0.000" />
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input class="form-control @error('stock') is-invalid @enderror" type="number" name="stock" required value="{{ old('stock') }}" placeholder="0" />
                    @error('stock')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input class="form-control @error('origin') is-invalid @enderror" type="text" name="origin" required value="{{ old('origin', 'الكويت') }}" placeholder="منشأ المنتج" />
                    @error('origin')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input class="form-control @error('weight') is-invalid @enderror" type="number" step="0.001" name="weight" value="{{ old('weight') }}" placeholder="0.000" />
                    @error('weight')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-6 mb-3">
                    ...
                    <input class="form-control @error('unit') is-invalid @enderror" type="text" name="unit" required value="{{ old('unit', 'كيلو') }}" placeholder="كيلو" />
                    @error('unit')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <textarea name="nutritional_info" class="form-control" rows="4" placeholder="المعلومات الغذائية للمنتج">{{ old('nutritional_info') }}</textarea>
                </div>
                <div class="col-md-6 mb-3">
                    <label class="form-label">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-check">
                        <input class="form-check-input @error('is_featured') is-invalid @enderror" type="checkbox" name="is_featured" id="is_featured" value="1" {{ old('is_featured') ? 'checked' : '' }} />
                ...
                <div class="col-md-3">
                    <div class="form-check">
                        <input class="form-check-input @error('is_fresh') is-invalid @enderror" type="checkbox" name="is_fresh" id="is_fresh" value="1" {{ old('is_fresh') ? 'checked' : '' }} />
                ...
                <div class="col-md-3">
                    <div class="form-check">
                        <input class="form-check-input @error('is_active') is-invalid @enderror" type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', true) ? 'checked' : '' }} />
...
<div id="loading-overlay" class="loading-overlay" style="display: none;">
    <div class="loading-content">
        <img src="/public/c7e1b7b5753737039e1bdbda578132b8.gif" alt="Loading..." class="loading-gif">
        <p>جاري التحميل...</p>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function addImageToGallery(imagePath) {
        ...
        galleryItem.innerHTML = `
            <img src="/storage/${imagePath}" alt="Gallery Image" class="gallery-image" style="width: 100px; height: 100px; object-fit: cover;">
            <div class="gallery-overlay">
                <button type="button" class="btn btn-sm btn-outline-primary" onclick="openImageLightbox('/storage/${imagePath}')">
                    <i class="fas fa-eye"></i>
                </button>
                <button type="button" class="remove-btn" onclick="removeImageFromGallery(this)">
    ...
    // Make removeImageFromGallery globally available
    window.removeImageFromGallery = function(button) {
    ...
    window.openImageLightbox = function(imagePath) {
