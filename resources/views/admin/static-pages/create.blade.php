        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">إضافة صفحة جديدة</h3>
                    <a href="{{ route('admin.static-pages.index') }}" class="btn btn-secondary float-right">
                        <i class="fas fa-arrow-right"></i> العودة
                    </a>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.static-pages.store') }}" method="POST" id="pageForm">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="is_fixed" name="is_fixed" 
                                               value="1" {{ old('is_fixed') ? 'checked' : '' }}>
                                        <label class="form-check-label" for="is_fixed">
                                            صفحة ثابتة (غير قابلة للتعديل)
                                        </label>
                                    </div>
                                </div>
                            </div>
